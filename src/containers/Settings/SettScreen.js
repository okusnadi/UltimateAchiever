				...
				<Card>
					<View style={{flexDirection: 'row' ,padding: 10}}>
						...
						<Picker
							...
							onValueChange={(itemValue, itemIndex) => this.props.pomoStore.setTimeSession(itemValue)}>
					...
					<View style={{flexDirection: 'row' ,padding: 10}}>
						...
						<Picker
							...
							onValueChange={(itemValue, itemIndex) => this.props.pomoStore.setTimeBreak(itemValue)}>
					...
					<View style={{flexDirection: 'row' ,padding: 10}}>
						...
						<Picker
							...
							onValueChange={(itemValue, itemIndex) => this.props.pomoStore.setTimePause(itemValue)}>
							<Picker.Item label="5" value="5" />
							<Picker.Item label="10" value="10" />
							<Picker.Item label="15" value="15" />
							<Picker.Item label="20" value="20" />
